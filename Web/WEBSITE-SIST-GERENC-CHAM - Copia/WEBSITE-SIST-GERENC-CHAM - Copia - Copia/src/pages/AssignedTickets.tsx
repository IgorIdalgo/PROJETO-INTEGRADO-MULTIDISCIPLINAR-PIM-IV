      ...
      <div className="w-full max-w-[1400px] mx-auto flex flex-col gap-4 p-4 md:p-6 h-full">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm md:text-base">
            ...
            <span className="font-semibold text-foreground">Meus Atribuídos</span>
          </div>
        ...
        <Card className="flex-1 overflow-hidden">
          ...
          <CardContent className="space-y-3 max-h-[70vh] overflow-auto">
            ...
            {!loading && myAssigned.length === 0 && <div className="text-sm text-muted-foreground">Nenhum chamado atribuído.</div>}
            {myAssigned
              .slice()
